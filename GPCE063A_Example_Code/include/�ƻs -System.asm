...
?L_Wait_AD_Ready_LinIn:
	...
	//R1 = C_ADC_CLK_FPLL_Div_32 | C_ADC_Manual_AN0 | C_ADC_Auto_Scan_1 | C_ADC_Timer_A;
	//R1 = C_ADC_CLK_FPLL_Div_32 | C_ADC_Manual_AN0 | C_ADC_Timer_A
	R1 =C_ADC_Enable| C_ADC_CLK_FPLL_Div_32 | C_ADC_Timer_A | C_ADC_Manual_AN0 | C_ADC_Enable | C_ADC_Ch0_in_LineinPB0 | C_ADC_MIC_Disable;
	[P_ADC_Ctrl] = R1;
