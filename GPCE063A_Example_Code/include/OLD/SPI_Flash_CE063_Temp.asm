...
F_SPI_Initial:
	push R1, R2 to [SP];
//	R1 = C_WDG_FRTC_Div_4096 | C_FXTAL_Div128 | C_SPU_Disable | C_Fosc_Mul9 | C_FPLL_Div1;
//	[P_SystemClock] = R1;
	// Set DI as input; DO, SCK, CS as output
	R1 = [P_IOA_Dir];
	R1 &= ~C_SPI_SI_Bit;
...
F_SPI_ReadAWord:
	push r2, r4 to [sp];
	clrb [P_IOA_Data], C_SPI_CS_IO;		// enable SPI Flash
...
//	[P_SPI_RX_Status] = R1;
	...
	setb [P_IOA_Data], C_SPI_CS_IO;	// disable SPI Flash
	pop R2, R4 from [SP];
	retf;
	.endp
