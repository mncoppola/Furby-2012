...
// Command: C:\PROGRA~1\GENERA~1\UNSPID~1.4\toolchain\cc1.exe C:\DOCUME~1\raycheng\LOCALS~1\Temp\cc8cttKU.i -fkeep-inline-functions -quiet -dumpbase main.c -mglobal-var-iram -gstabs -o .\Debug/main.asm
	.external __sn_func_ptr_sec

// gcc2_compiled.:

.debug
	.dw '.stabs "D:/WorkingFolder/Library_Release/SACMV41b_Beta/GPCE063A_Example_V41b/GPCE063A Example Code/S480/",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.debug
	.dw '.stabs "D:/WorkingFolder/Library_Release/SACMV41b_Beta/GPCE063A_Example_V41b/GPCE063A Example Code/S480/main.c",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.code
Ltext0:
.debug
...
.code
LM10:
	CALL _SACM_S480_Initial	// call without return value
.debug
...
.code
LM22:
	CALL _SACM_S480_Pause	// call without return value
.debug
...
.code
LM24:
	CALL _SACM_S480_Resume	// call without return value
.debug
...
LM33:
	...
	[SP--]=R1	// QImode move
	CALL _USER_S480_Volume	// call without return value
	SP = SP + 1	//SP
.debug
...
LM37:
	...
	[SP--]=R1	// QImode move
	CALL _SACM_S480_DA_FIRType	// call without return value
	SP = SP + 1	//SP
.debug
...
LM41:
	R1=[_SpeechIndex]	// QImode move
	[SP--]=R1	// QImode move
	CALL _USER_S480_SetStartAddr	// call with return value
	SP = SP + 1	//SP
.debug
...
.code
LM47:
	CALL _SACM_S480_Check_Con	// call with return value
	CMP R1,(-1)	// QImode compare
	NSJNZ L23	//QImode NE
.debug
...
LM50:
	R1=[_SpeechIndex]	// QImode move
	[SP--]=R1	// QImode move
	CALL _USER_S480_SetStartAddr_Con	// call with return value
	SP = SP + 1	//SP
.debug
...
LM51:
	...
	R1=(-1)	// QImode move
	[SP--]=R1	// QImode move
	CALL _SACM_S480_Play_Con	// call without return value
	SP = SP + 3	//SP
.debug
...
.external _SACM_S480_Play_Con
.external _USER_S480_SetStartAddr_Con
.external _SACM_S480_Check_Con
.external _USER_S480_SetStartAddr
.external _SACM_S480_DA_FIRType
.external _USER_S480_Volume
.external _SACM_S480_Resume
