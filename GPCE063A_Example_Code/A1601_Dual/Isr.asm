...
.define C_A1601_CH1		0x0001
.define C_A1601_CH2		0x0002
//**************************************************************************
...
.if ServiceType == Background
	...
	R1 |= R2;
	[R_A1601_CHx_Flag] = R1;
	test R1, C_A1601_CH1 | C_A1601_CH2;
...
L_ForBackgroundUsage:
	...
	test R1, C_A1601_CH1;
	jz ?L_CheckCH2;
	call F_SACM_A1601_ServiceLoop;	// SACM Service Loop
?L_CheckCH2:
	test R1, C_A1601_CH2;
	jz ?L_End;
	call F_SACM_A1601_CH2_ServiceLoop;	// SACM Service Loop
?L_End:
	pop R1, R5 from [SP];
	reti;
.endif
