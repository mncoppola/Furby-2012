...
// Command: C:\PROGRA~1\GENERA~1\UNSPID~1.4\toolchain\cc1.exe C:\DOCUME~1\raycheng\LOCALS~1\Temp\ccekpWnx.i -fkeep-inline-functions -quiet -dumpbase main.c -mglobal-var-iram -gstabs -o .\Debug/main.asm
	.external __sn_func_ptr_sec

// gcc2_compiled.:

.debug
	.dw '.stabs "D:/WorkingFolder/Library_Release/SACMV41b_Beta/GPCE063A_Example_V41b/GPCE063A Example Code/DVR1600/",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.debug
	.dw '.stabs "D:/WorkingFolder/Library_Release/SACMV41b_Beta/GPCE063A_Example_V41b/GPCE063A Example Code/DVR1600/main.c",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.code
Ltext0:
.debug
...
LM21:
	...
	R1=4	// QImode move
	[SP--]=R1	// QImode move
	CALL _USER_DVR1600_SetStartAddr	// call with return value
	SP = SP + 2	//SP
.debug
...
.code
LM42:
	CALL _SACM_DVR1600_Pause	// call without return value
	PC=L15	// jump
L14:
.debug
...
.code
LM43:
	CALL _SACM_DVR1600_Resume	// call without return value
L15:
.debug
...
LM47:
	...
	[SP--]=R1	// QImode move
	CALL _USER_DVR1600_Volume	// call without return value
	SP = SP + 1	//SP
.debug
...
LM51:
	...
	[SP--]=R1	// QImode move
	CALL _SACM_DVR1600_DA_FIRType	// call without return value
	SP = SP + 1	//SP
.debug
...
.code
LM64:
	CALL _SACM_DVR1600_Check_Con	// call with return value
	CMP R1,(-1)	// QImode compare
	NSJNZ L25	//QImode NE
.debug
...
LBB4:
	R1=[_SpeechIndex]	// QImode move
	[SP--]=R1	// QImode move
	CALL _USER_DVR1600_SetStartAddr_Con	// call with return value
	SP = SP + 1	//SP
.debug
...
LM66:
	...
	R1=(-1)	// QImode move
	[SP--]=R1	// QImode move
	CALL _SACM_DVR1600_Play_Con	// call without return value
	SP = SP + 3	//SP
.debug
...
.external _SACM_DVR1600_Play_Con
.external _USER_DVR1600_SetStartAddr_Con
.external _SACM_DVR1600_Check_Con
.external _SACM_DVR1600_DA_FIRType
.external _USER_DVR1600_Volume
.external _SACM_DVR1600_Resume
.external _SACM_DVR1600_Pause
.external _SACM_DVR1600_Stop
.external _SACM_DVR1600_Rec
.external _USER_DVR1600_SetStartAddr
