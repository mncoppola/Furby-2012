...
// Command: C:\PROGRA~1\GENERA~1\UNSPID~1.4\toolchain\cc1.exe C:\DOCUME~1\raycheng\LOCALS~1\Temp\ccGrFEj9.i -fkeep-inline-functions -quiet -dumpbase main.c -mglobal-var-iram -gstabs -o .\Debug/main.asm
	.external __sn_func_ptr_sec

// gcc2_compiled.:

.debug
	.dw '.stabs "D:/WorkingFolder/Library_Release/SACMV41b_Beta/GPCE063A_Example_V41b/GPCE063A Example Code/DVR520/",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.debug
	.dw '.stabs "D:/WorkingFolder/Library_Release/SACMV41b_Beta/GPCE063A_Example_V41b/GPCE063A Example Code/DVR520/main.c",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.code
Ltext0:
.debug
...
.CODE
.debug
	.dw '.stabs "VADIndex:G4",32,0,0,',0,0,offset _VADIndex,seg _VADIndex,0x0d,0x0a
.CODE
.debug
...
.code
LM13:
	CALL _SACM_DVR520_Initial	// call without return value
.debug
...
.code
LM14:
	R1=[_VADIndex]	// QImode move
	[SP--]=R1	// QImode move
	CALL _SACM_DVR520_VADTHR	// call with return value
	SP = SP + 1	//SP
.debug
...
LM15:
	...
	[SP--]=R1	// QImode move
	CALL _SACM_DVR520_Play	// call without return value
	SP = SP + 3	//SP
.debug
...
LM23:
	...
	R1=4	// QImode move
	[SP--]=R1	// QImode move
	CALL _USER_DVR520_SetStartAddr	// call with return value
	SP = SP + 2	//SP
.debug
...
LM25:
	...
	R1=0	// QImode move
	[SP--]=R1	// QImode move
	CALL _SACM_DVR520_Rec	// call without return value
	SP = SP + 2	//SP
.debug
...
.code
LM28:
	CALL _SACM_DVR520_Stop	// call without return value
.debug
...
.code
LM43:
	CALL _SACM_DVR520_Pause	// call without return value
	PC=L15	// jump
L14:
.debug
...
.code
LM44:
	CALL _SACM_DVR520_Resume	// call without return value
L15:
.debug
...
LM48:
	...
	[SP--]=R1	// QImode move
	CALL _USER_DVR520_Volume	// call without return value
	SP = SP + 1	//SP
.debug
...
LM52:
	...
	[SP--]=R1	// QImode move
	CALL _SACM_DVR520_DA_FIRType	// call without return value
	SP = SP + 1	//SP
.debug
...
.code
LM63:
	CALL _SACM_DVR520_Check_Con	// call with return value
	CMP R1,(-1)	// QImode compare
	NSJNZ L25	//QImode NE
.debug
...
LM66:
	R1=[_SpeechIndex]	// QImode move
	[SP--]=R1	// QImode move
	CALL _USER_DVR520_SetStartAddr_Con	// call with return value
	SP = SP + 1	//SP
.debug
...
LM67:
	...
	R1=(-1)	// QImode move
	[SP--]=R1	// QImode move
	CALL _SACM_DVR520_Play_Con	// call without return value
	SP = SP + 3	//SP
.debug
...
.code
LM69:
	CALL _SACM_DVR520_ServiceLoop	// call without return value
L28:
.debug
...
.external _SACM_DVR520_ServiceLoop
.external _SACM_DVR520_Play_Con
.external _USER_DVR520_SetStartAddr_Con
.external _SACM_DVR520_Check_Con
.external _SACM_DVR520_DA_FIRType
.external _USER_DVR520_Volume
.external _SACM_DVR520_Resume
.external _SACM_DVR520_Pause
.external _SACM_DVR520_Stop
.external _SACM_DVR520_Rec
.external _USER_DVR520_SetStartAddr
.external _SPI_Flash_Sector_Erase
.external _SP_GetCh
.external _SACM_DVR520_Play
.external _SACM_DVR520_VADTHR
.external _SACM_DVR520_Initial
