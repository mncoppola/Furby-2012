...
// Command: C:\PROGRA~1\GENERA~1\UNSPID~1.1\toolchain\cc1.exe C:\DOCUME~1\chimc\LOCALS~1\Temp\ccIWk2dl.i -fkeep-inline-functions -quiet -dumpbase main.c -mglobal-var-iram -gstabs -o .\Debug/main.asm
	.external __sn_func_ptr_sec

// gcc2_compiled.:

.debug
	.dw '.stabs "V:/svn/Library/16-bit/SACM_Library/Example Code/SACM Example Code/GPCE063A Example Code/DVR4800/",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.debug
	.dw '.stabs "V:/svn/Library/16-bit/SACM_Library/Example Code/SACM Example Code/GPCE063A Example Code/DVR4800/main.c",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.code
Ltext0:
.debug
...
.code
LM12:
	CALL _SACM_DVR4800_Initial	// call without return value
.debug
...
LM13:
	...
	[SP--]=R1	// QImode move
	CALL _SACM_DVR4800_Play	// call without return value
	SP = SP + 3	//SP
.debug
...
LM21:
	...
	R1=4	// QImode move
	[SP--]=R1	// QImode move
	CALL _USER_DVR4800_SetStartAddr	// call with return value
	SP = SP + 2	//SP
.debug
...
LM24:
	...
	R1=0	// QImode move
	[SP--]=R1	// QImode move
	CALL _SACM_DVR4800_Rec	// call without return value
	SP = SP + 3	//SP
.debug
...
.code
LM27:
	CALL _SACM_DVR4800_Stop	// call without return value
.debug
...
.code
LM42:
	CALL _SACM_DVR4800_Pause	// call without return value
	PC=L15	// jump
L14:
.debug
...
.code
LM43:
	CALL _SACM_DVR4800_Resume	// call without return value
L15:
.debug
...
LM47:
	...
	[SP--]=R1	// QImode move
	CALL _USER_DVR4800_Volume	// call without return value
	SP = SP + 1	//SP
.debug
...
LM51:
	...
	[SP--]=R1	// QImode move
	CALL _SACM_DVR4800_DA_FIRType	// call without return value
	SP = SP + 1	//SP
.debug
...
.code
LM62:
	CALL _SACM_DVR4800_Check_Con	// call with return value
	CMP R1,(-1)	// QImode compare
	NSJNZ L25	//QImode NE
.debug
...
LM65:
	R1=[_SpeechIndex]	// QImode move
	[SP--]=R1	// QImode move
	CALL _USER_DVR4800_SetStartAddr_Con	// call with return value
	SP = SP + 1	//SP
.debug
...
LM66:
	...
	R1=(-1)	// QImode move
	[SP--]=R1	// QImode move
	CALL _SACM_DVR4800_Play_Con	// call without return value
	SP = SP + 3	//SP
.debug
...
.code
LM69:
	CALL _SACM_DVR4800_ServiceLoop	// call without return value
L28:
.debug
...
.external _SACM_DVR4800_ServiceLoop
.external _SACM_DVR4800_Play_Con
.external _USER_DVR4800_SetStartAddr_Con
.external _SACM_DVR4800_Check_Con
.external _SACM_DVR4800_DA_FIRType
.external _USER_DVR4800_Volume
.external _SACM_DVR4800_Resume
.external _SACM_DVR4800_Pause
.external _SACM_DVR4800_Stop
.external _SACM_DVR4800_Rec
.external _USER_DVR4800_SetStartAddr
.external _SPI_Flash_Sector_Erase
.external _SP_GetCh
.external _SACM_DVR4800_Play
.external _SACM_DVR4800_Initial
