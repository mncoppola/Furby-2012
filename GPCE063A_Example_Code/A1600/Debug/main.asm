...
// Command: C:\PROGRA~1\GENERA~1\UNSPID~1.4\toolchain\cc1.exe C:\DOCUME~1\raycheng\LOCALS~1\Temp\ccSACT9j.i -fkeep-inline-functions -quiet -dumpbase main.c -mglobal-var-iram -gstabs -Wall -o .\Debug/main.asm
	.external __sn_func_ptr_sec

// gcc2_compiled.:

.debug
	.dw '.stabs "D:/WorkingFolder/Library_Release/SACMV41b_Beta/GPCE063A_Example_V41b/GPCE063A Example Code/A1600/",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.debug
	.dw '.stabs "D:/WorkingFolder/Library_Release/SACMV41b_Beta/GPCE063A_Example_V41b/GPCE063A Example Code/A1600/main.c",0x64,0,3,',0,0,offset Ltext0,seg Ltext0,0x0d,0x0a
.code
.code
Ltext0:
.debug
...
.code
LM20:
	CALL _SACM_A1600_Stop	// call without return value
.debug
...
.code
LM22:
	CALL _SACM_A1600_Pause	// call without return value
.debug
...
.code
LM24:
	CALL _SACM_A1600_Resume	// call without return value
.debug
...
LM33:
	...
	[SP--]=R1	// QImode move
	CALL _USER_A1600_Volume	// call without return value
	SP = SP + 1	//SP
.debug
...
LM37:
	...
	[SP--]=R1	// QImode move
	CALL _SACM_A1600_DA_FIRType	// call without return value
	SP = SP + 1	//SP
.debug
...
LM41:
	R1=[_SpeechIndex]	// QImode move
	[SP--]=R1	// QImode move
	CALL _USER_A1600_SetStartAddr	// call without return value
	SP = SP + 1	//SP
.debug
...
.code
LM46:
	CALL _SACM_A1600_Check_Con	// call with return value
	CMP R1,(-1)	// QImode compare
	NSJNZ L23	//QImode NE
.debug
...
LM49:
	R1=[_SpeechIndex]	// QImode move
	[SP--]=R1	// QImode move
	CALL _USER_A1600_SetStartAddr_Con	// call without return value
	SP = SP + 1	//SP
.debug
...
LM50:
	...
	R1=(-1)	// QImode move
	[SP--]=R1	// QImode move
	CALL _SACM_A1600_Play_Con	// call without return value
	SP = SP + 3	//SP
L24:
L23:
.debug
...
.external _SACM_A1600_Play_Con
.external _USER_A1600_SetStartAddr_Con
.external _SACM_A1600_Check_Con
.external _USER_A1600_SetStartAddr
.external _SACM_A1600_DA_FIRType
.external _USER_A1600_Volume
.external _SACM_A1600_Resume
.external _SACM_A1600_Pause
.external _SACM_A1600_Stop
.external _SP_GetCh
